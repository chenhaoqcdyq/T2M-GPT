...
vq_name = f"VQVAE-T2MGPT-SEM-train-{exp_name}-upsample-{args.upsample_factor}"
...
##### ---- Dataloader ---- #####
train_loader_token = dataset_tokenize.DATALoader(args.dataname, 1, unit_length=1, upsample_factor=args.upsample_factor)
...
if args_vq.lgvq == 1:
    ...
    if args.upsample_factor > 1:
        unit_length = unit_length // args.upsample_factor
...
while nb_iter <= args.total_iter:
    ...
    if nb_iter % args.eval_iter ==  0:
        best_fid, best_iter, best_div, best_top1, best_top2, best_top3, best_matching, writer, logger = eval_trans.evaluation_transformer_batch(args.out_dir, val_loader, net, trans_encoder, logger, writer, nb_iter, best_fid, best_iter, best_div, best_top1, best_top2, best_top3, best_matching, clip_model=clip_model, eval_wrapper=eval_wrapper, semantic_flag=((args_vq.lgvq==1 or args.test_nb) and args.sample_way != 2), draw=False, dual_head_flag=(args.sample_way == 2), upsample_factor=args.upsample_factor)
